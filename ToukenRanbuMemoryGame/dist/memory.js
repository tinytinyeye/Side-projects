...
var gameArea = {
    ...
    init : function() {
        ...
        this.canvas.addEventListener("touchstart", touchDown, false);
        loadImages();
        this.repaint();
    },
    gameStart : function() {
...
// Preload all images.
function loadImages() {
	var imgs = ["img/Card1.png", "img/Card2.png", "img/Card3.png", 
			"img/Card4.png", "img/Card5.png", "img/Card6.png", 
			"img/Card7.png", "img/Card8.png", "img/Card9.png", 
			"img/Card10.png", "img/Card11.png", "img/Card12.png", 
			"img/Card13.png", "img/Card14.png", "img/Card15.png", 
			"img/Card16.png", "img/Card17.png", "img/Card18.png", 
			"img/Card19.png", "img/Card20.png", "img/Card21.png", 
			"img/Card22.png", "img/Card23.png", "img/Card24.png", 
			"img/Card25.png", "img/Card26.png", "img/Card27.png", 
			"img/Card28.png", "img/Card29.png", "img/Card30.png", 
			"img/Card31.png", "img/Card32.png", "img/Card33.png", 
			"img/Card34.png", "img/Card35.png", "img/Card36.png", 
			"img/Card37.png", "img/Card38.png", "img/Card39.png", 
			"img/Card40.png", "img/Card41.png", "img/Card42.png", 
			"img/Card43.png", "img/Card44.png", "img/Card44.png", 
			"img/CardBack1.jpg",
